...
function App() {
  ...
  <Avatar size="xlarge" shape="circle"  style={{width:250,height:250, display:'block',marginLeft:'auto', marginRight: 'auto'}}>
    ...
    <h1 style={{textAlign:'center'}}>Mohamed Ayman Yakhmim</h1>
...
<footer style={{textAlign: 'center', marginBottom:'15px'}}>
  ...
  <p>Contactez-moi : <a href='https://mail.google.com/mail/u/0/#inbox?compose=new' target='_blank'> aymanyakhmim1@gmail.com</a></p>
  
  <span className='pi pi-github'> 
  
  <a href='https://github.com/AymanYakhmim' target='_blank'>AymanYakhmim</a>
